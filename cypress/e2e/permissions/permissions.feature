Feature: Permissions manipulation
  ...
  @test
  Scenario: Cancel creation of a permission
    Given I am logged in as admin
    And I am on "permissions" page
    ...
    When I type in the "modal-textbox-permission-name" textbox text "a_permission_cancel"
    Then I should see "a_permission_cancel" in the "modal-textbox-permission-name" textbox

    When I click on the "modal-button-cancel" button
    Then I should not see "add-permission-modal" modal
    And I should not see "a_permission_cancel" entry in the data table
  ...
  @test
  Scenario: Refresh button reloads the data
    Given I am logged in as admin
    And I am on "permissions" page

    When I click on the "permissions-button-refresh" button
    Then I should see the "permissions-button-refresh" button is enabled
