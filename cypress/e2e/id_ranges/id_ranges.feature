Feature: ID Range manipulation
    ...
    @test
    Scenario: Add a new ID range (AD trust with POSIX attributes) that fails due to missing trust
        Given I am logged in as admin
        And I am on "id-ranges" page
        ...
        When I type in the "modal-textbox-range-name" textbox text "fail_id_range_ad_trust_posix"
        Then I should see "fail_id_range_ad_trust_posix" in the "modal-textbox-range-name" textbox
    ...
    @test
    Scenario: Add a new ID range with existing base ID
        Given I am logged in as admin
        And I am on "id-ranges" page
